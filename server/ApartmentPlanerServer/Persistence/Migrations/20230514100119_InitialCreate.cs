        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Commentary = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 5, 14, 10, 1, 18, 349, DateTimeKind.Utc).AddTicks(2804)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@admin.com", "admin", "admin", "$argon2id$v=19$m=65536,t=3,p=1$EKfGZU6D++sQeoqpSFYpOw$FMRRnRQ55gXmrNPo8DoxFcUU1CsgfI425cNciZHwQGA", 1 });
